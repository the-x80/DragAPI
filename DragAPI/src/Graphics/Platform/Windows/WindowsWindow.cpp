...
DragAPI::Window* DragAPI::Window::Create(const wchar_t* tittle, DragAPI::Rect<int> rect, DragAPI::Events::EventDispatcher* dispatcher) {
...
namespace DragAPI {
    ...
    WindowsWindow::WindowsWindow(Events::EventDispatcher* dispatcher) :
        m_Handle((HWND)INVALID_HANDLE_VALUE),
        m_WindowClass(),
        m_Tittle(L""),
    ...
    void WindowsWindow::Initialize(const wchar_t* tittle, Rect<int> rect) {
    ...
    void WindowsWindow::SetEventDispatcher(DragAPI::Events::EventDispatcher* e) {
